...
One of the main reasons for the choice of maven is that its [naming conventions](concepts/artifact-naming) fit well with Semantic Web concepts.
...
* 💠 Semantic Web Interoperability: Represent [Maven Coordinates](concepts/artifact-naming) as URNs for use in RDF documents.
